...
static Lexeme *matchedKeyword(char *str) {
	...
	// Workspaces
	else if (strcmp(str, WORKSPACES) == 0) { free(str); return newLexeme(WORKSPACES, UNDEFINED, UNDEFINED, UNDEFINED, line); }
	...
	else if (strcmp(str, DISAMBIGUATION) == 0) { free(str); return newLexeme(DISAMBIGUATION, UNDEFINED, UNDEFINED, UNDEFINED, line); }
